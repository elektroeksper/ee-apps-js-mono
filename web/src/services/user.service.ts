...
export class UserService {
    ...
    try {
      ...
      if (filter) {
        ...
        if (filter.isDeleted !== undefined)
          params.append('isDeleted', filter.isDeleted.toString())
      }
  ...
  async approveBusiness(userId: string): Promise<IOperationResult<IAppUser>> {
    ...
    return {
      success: false,
      error:
        'approveBusiness should be implemented via business service - operates on business document, not user.businessInfo',
    }
  }
  ...
  async rejectBusiness(
    ...
    return {
      success: false,
      error:
        'rejectBusiness should be implemented via business service - operates on business document, not user.businessInfo',
    }
  }

  async clearBusinessRejection(
    userId: string
  ): Promise<IOperationResult<IAppUser>> {
    ...
    return {
      success: false,
      error:
        'clearBusinessRejection should be implemented via business service - user.businessInfo is for user-business relationship data only',
    }
  }
  ...
  async acceptBusinessInvitation(
    ...
    return {
      success: false,
      error:
        'acceptBusinessInvitation method not yet implemented with API routes',
    }
  }
}
