...
exports.getFileDisplayName = exports.getCategoryDisplayName = exports.getUserDocuments = exports.storageClientService = exports.StorageClientService = void 0;
const functions_1 = require("firebase/functions");
const firebase_1 = require("../../../shared/src/configs/firebase");
/**
...
class StorageClientService {
    ...
    async getUserDocuments(userId) {
        try {
            const getUserDocumentsFunction = (0, functions_1.httpsCallable)(firebase_1.functions, 'getUserDocuments');
     ...
     */
    async uploadUserDocument(userId, file, category) {
        try {
            // Convert file to base64 for transmission
            const fileData = await this.fileToBase64(file);
            const uploadDocumentFunction = (0, functions_1.httpsCallable)(firebase_1.functions, 'uploadUserDocument');
     ...
     */
    async deleteUserDocument(userId, documentPath) {
        try {
            const deleteDocumentFunction = (0, functions_1.httpsCallable)(firebase_1.functions, 'deleteUserDocument');
...
exports.StorageClientService = StorageClientService;
// Export singleton instance
exports.storageClientService = new StorageClientService();
// Export convenience functions
exports.getUserDocuments = exports.storageClientService.getUserDocuments, exports.getCategoryDisplayName = exports.storageClientService.getCategoryDisplayName, exports.getFileDisplayName = exports.storageClientService.getFileDisplayName;
