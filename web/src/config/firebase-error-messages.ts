...
export function getFirebaseErrorMessage(
  ...
  if (
    !authMessage.includes('kimlik doğrulama hatası') &&
    !authMessage.includes('authentication error')
  ) {
    return authMessage
  }
  ...
  if (
    !storageMessage.includes('depolama hatası') &&
    !storageMessage.includes('storage error')
  ) {
  ...
  if (
    !firestoreMessage.includes('veritabanı hatası') &&
    !firestoreMessage.includes('database error')
  ) {
