      ...
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav className="mb-8">
          <ol className="flex items-center space-x-2">
            ...
            <li className="text-gray-900 font-medium">Hizmetler</li>
          </ol>
        </nav>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
            ...
            <div className="p-6">
              <h3 className="text-xl font-bold text-gray-900 mb-2">Elektrik Tesisatı</h3>
          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
            ...
            <div className="p-6">
              <h3 className="text-xl font-bold text-gray-900 mb-2">Elektronik Tamir</h3>
              <p className="text-gray-600 mb-4">
          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
            ...
            <div className="p-6">
              <h3 className="text-xl font-bold text-gray-900 mb-2">Güvenlik Sistemleri</h3>
              <p className="text-gray-600 mb-4">
          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
            ...
            <div className="p-6">
              <h3 className="text-xl font-bold text-gray-900 mb-2">Aydınlatma Sistemleri</h3>
              <p className="text-gray-600 mb-4">
          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
            ...
            <div className="p-6">
              <h3 className="text-xl font-bold text-gray-900 mb-2">Acil Servis</h3>
              <p className="text-gray-600 mb-4">
          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
            ...
            <div className="p-6">
              <h3 className="text-xl font-bold text-gray-900 mb-2">Danışmanlık</h3>
              <p className="text-gray-600 mb-4">
