...
export interface IContentService {
  ...
  addSliderItem(
    item: Omit<ISliderItem, 'id' | 'createdAt' | 'updatedAt'>
  ): Promise<IContentOperationResult<void>>
  updateSliderItem(
    id: string,
    item: Partial<ISliderItem>
  ): Promise<IContentOperationResult<void>>
  ...
  addService(
    service: Omit<IServiceItem, 'id' | 'createdAt' | 'updatedAt'>
  ): Promise<IContentOperationResult<void>>
  updateService(
    id: string,
    service: Partial<IServiceItem>
  ): Promise<IContentOperationResult<void>>
  ...
  updateVideoSettings(
    location: VideoLocation,
    settings: Partial<IVideoSettings>
  ): Promise<IContentOperationResult<void>>
}
